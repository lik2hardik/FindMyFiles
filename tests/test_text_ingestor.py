...
def test_text_ingestor_outputs_valid_type(tmp_path):
    test_file = tmp_path / "test.txt"
    test_file.write_text("Hello World")
...
def test_text_ingestor_throws_type_error(tmp_path):
...
def test_text_ingestor_valid_multiple_accepted(tmp_path):
    test_file = tmp_path / "test.txt"
    test_file.write_text("Hello World")
